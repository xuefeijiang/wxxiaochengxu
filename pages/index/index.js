...
Page({
  ...
  data: {
    //轮播图
    imgUrls: [
      '/post/post-1@text.jpg',
      '/post/post-2@text.jpg',
      '/post/post-3@text.jpg'
    ],
    indicatorDots: true,
    autoplay: true,
    interval: 3000,
      ...
      comments: [
        {
          ...
          content: {
            ...
            img: ["/comment/train-1.jpg", "/comment/train-2.jpg", "/comment/train-3.jpg"],
            audio: null
          }
        }, {
          username: '水清',
